...
function _s_theme_options_init() {
	...
	add_settings_field(
		...
		__( 'Sample Checkbox', 'joesnellpdx' ), // Setting field label
		'_s_settings_field_sample_checkbox', // Function that renders the settings field
		'theme_options', // Menu slug, used to uniquely identify the page; see _s_theme_options_add_page()
		'general' // Settings section. Same as the first argument in the add_settings_section() above
	);

	add_settings_field( 'sample_text_input', __( 'Sample Text Input', 'joesnellpdx' ), '_s_settings_field_sample_text_input', 'theme_options', 'general' );
	add_settings_field( 'sample_select_options', __( 'Sample Select Options', 'joesnellpdx' ), '_s_settings_field_sample_select_options', 'theme_options', 'general' );
	add_settings_field( 'sample_radio_buttons', __( 'Sample Radio Buttons', 'joesnellpdx' ), '_s_settings_field_sample_radio_buttons', 'theme_options', 'general' );
	add_settings_field( 'sample_textarea', __( 'Sample Textarea', 'joesnellpdx' ), '_s_settings_field_sample_textarea', 'theme_options', 'general' );
}
...
function _s_theme_options_add_page() {
	$theme_page = add_theme_page(
		__( 'Theme Options', 'joesnellpdx' ),   // Name of page
		__( 'Theme Options', 'joesnellpdx' ),   // Label in menu
...
/**
 * Returns an array of sample select options registered for Joesnellpdx.
 *
 * @since Joesnellpdx 1.0
 */
function _s_sample_select_options() {
	$sample_select_options = array(
		'0' => array(
			'value' =>	'0',
			'label' => __( 'Zero', 'joesnellpdx' )
		),
		'1' => array(
			'value' =>	'1',
			'label' => __( 'One', 'joesnellpdx' )
		),
		'2' => array(
			'value' => '2',
			'label' => __( 'Two', 'joesnellpdx' )
		),
		'3' => array(
			'value' => '3',
			'label' => __( 'Three', 'joesnellpdx' )
		),
		'4' => array(
			'value' => '4',
			'label' => __( 'Four', 'joesnellpdx' )
		),
		'5' => array(
			'value' => '3',
			'label' => __( 'Five', 'joesnellpdx' )
		)
	);
...
/**
 * Returns an array of sample radio options registered for Joesnellpdx.
 *
 * @since Joesnellpdx 1.0
 */
function _s_sample_radio_buttons() {
	$sample_radio_buttons = array(
		'yes' => array(
			'value' => 'yes',
			'label' => __( 'Yes', 'joesnellpdx' )
		),
		'no' => array(
			'value' => 'no',
			'label' => __( 'No', 'joesnellpdx' )
		),
		'maybe' => array(
			'value' => 'maybe',
			'label' => __( 'Maybe', 'joesnellpdx' )
		)
	);
...
/**
 * Returns the options array for Joesnellpdx.
 *
 * @since Joesnellpdx 1.0
 */
...
function _s_settings_field_sample_checkbox() {
	...
	<label for"sample-checkbox">
		...
		<?php _e( 'A sample checkbox.', 'joesnellpdx' );  ?>
	</label>
	<?php
}
...
function _s_settings_field_sample_text_input() {
	...
	<label class="description" for="sample-text-input"><?php _e( 'Sample text input', 'joesnellpdx' ); ?></label>
	<?php
}
...
function _s_settings_field_sample_select_options() {
	...
	<label class="description" for="sample_theme_options[selectinput]"><?php _e( 'Sample select input', 'joesnellpdx' ); ?></label>
	<?php
}
...
function _s_settings_field_sample_textarea() {
	...
	<label class="description" for="sample-textarea"><?php _e( 'Sample textarea', 'joesnellpdx' ); ?></label>
	<?php
}
...
function _s_theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<h2><?php printf( __( '%s Theme Options', 'joesnellpdx' ), get_current_theme() ); ?></h2>
		<?php settings_errors(); ?>
